...
$sql_id = "SELECT * FROM t_employeur WHERE email='$email' limit 1";
$result_id = mysqli_query($conn, $sql_id);
$employeur_id = mysqli_fetch_assoc($result_id);
$employeur_id_2 = $employeur_id['id'];
$nom = $employeur_id['nom'];
$prenom = $employeur_id['prenom'];



if (isset($_POST['ajouterMessage'])) {
    $message = htmlspecialchars($_POST['message'], ENT_QUOTES);
    $select_employe = $_POST['select_employe'];
    $objet = htmlspecialchars($_POST['objet'], ENT_QUOTES);
    $fichier = $_FILES["fichier"]["name"];
    $tempname_fichier = $_FILES["fichier"]["tmp_name"];
    if (!empty($message) && !empty($objet) && !empty($select_employe)) {
        ...
        $sql_email = "SELECT email FROM t_employe WHERE id='$select_employe'";
        $result_email = mysqli_query($conn, $sql_email);
        $emp_email = mysqli_fetch_assoc($result_email);
        $sql = "INSERT INTO t_messagerie(message,id_employe,objet,id_employeur,user_send_type) VALUES('$message','$select_employe','$objet','$employeur_id_2','employeur')";
        ...
        $mail->Password = 'msvmhxqjeujfwsgx';
        $mail->SMTPSecure = 'tls';
        $mail->Port = 587;
        ...
        $bodyContent .= "<div calss='card' style='width: 18rem;'>
            <img class='card-img-top' src='https://i.ibb.co/svhKncv/igs.jpg' alt='Card image cap'style='margin-top: 1px; height:25%; width:25%; float:left;'>
            <div class='card-body'>
        ...
        // Send email
        if ($mail->send() &&   $result && $result_fichier) {
                        ...
                        <div class="card-body">
                            <div>
                                <div class="form-group">
                                    ...
                                    <select class="form-select form-control" name="select_employe" aria-label="Default select example">

                                        <?php
                                        $sql_employe = "SELECT * FROM t_employe";
                                        if ($result_employe = mysqli_query($conn, $sql_employe)) :
                                            while ($row_employe = mysqli_fetch_assoc($result_employe)) :

                                        ?>
                                                <option value="<?php echo $row_employe['id'] ?>"><?php echo $row_employe['nom'] . " " . $row_employe['prenom'] . " | " . $row_employe['statut'] . " | " . $row_employe['service']; ?> </option>
                                        <?php
                                            endwhile;
                                        ...
                                        <div class="toolbar" role="toolbar">
                                            <div class="btn-group">
                                                <label type="button" class="btn btn-light" for="my-file-selector">
                                                    <input id="my-file-selector" type="file" class="" name="fichier">
                                                    <span class="fa fa-paperclip"></span>
                                                </label>
                                                <button type="button" class="btn btn-light" id="button_bold">
                            ...
                            <div class="table-responsive">
                                <table id="" class="table email-table no-wrap table-hover v-middle mb-0 font-14">
                                    <tbody>
                                        ...
                                        $sql = "SELECT DISTINCT t_messagerie.id,t_messagerie.objet , t_messagerie.message ,t_employe.nom ,t_employe.prenom,t_employe.email,t_employe.photo ,t_messagerie.created FROM t_messagerie INNER JOIN t_employeur ON t_messagerie.id_employeur='$employeur_id_2' INNER JOIN t_employe ON t_messagerie.id_employe=t_employe.id where t_messagerie.user_send_type='employe' ORDER BY t_messagerie.created Desc ";
                                                ...
                                                <div class="modal fade" id="<?php echo "exampleMoadal" . $row['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <img src="../img/database_image/<?php echo $row['photo']; ?> " alt="avatar" class="rounded-circle img-fluid" style="width:40px; height:40px;">
                            ...
                            <div class="table-responsive">
                                ...
                                <table id="" class="table email-table no-wrap table-hover v-middle mb-0 font-14">
                                    <tbody>
                                        ...
                                        $sql = "SELECT DISTINCT t_messagerie.id,t_messagerie.objet ,t_messagerie.message, t_employe.nom, t_employe.prenom,t_employe.email,t_employe.photo ,t_messagerie.created FROM t_messagerie INNER JOIN t_employeur ON t_messagerie.id_employeur='$employeur_id_2' INNER JOIN t_employe ON t_messagerie.id_employe=t_employe.id where t_messagerie.user_send_type='employeur' ORDER BY t_messagerie.created Desc ";
                                        if ($result = mysqli_query($conn, $sql)) :
                                            while ($row = mysqli_fetch_assoc($result)) :
                                        ...
                                        <?php
                                        $sql_employeur = "SELECT DISTINCT t_messagerie.id,t_messagerie.objet , t_messagerie.message ,t_messagerie.deleted_at,t_employe.nom ,t_employe.prenom,t_employe.email,t_employe.photo ,t_messagerie.created FROM t_messagerie INNER JOIN t_employeur ON t_messagerie.id_employeur='$employeur_id_2' INNER JOIN t_employe ON t_messagerie.id_employe=t_employe.id WHERE t_messagerie.user_send_type='employeur' AND t_messagerie.deleted_at IS NULL ORDER BY t_messagerie.created Desc ";
                                        if ($result_employeur = mysqli_query($conn, $sql_employeur)) :
                                            while ($row_employeur = mysqli_fetch_assoc($result_employeur)) :

                                        ?>
                                                <div class="modal fade" id="<?php echo "envoyerModal" . $row_employeur['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <img src="../img/database_image/<?php echo $row_employeur['photo']; ?> " alt="avatar" class="rounded-circle img-fluid" style="width:40px; height:40px;">
                                                                <?php echo $row_employeur['nom'] . " " . $row_employeur['prenom']; ?>
                                                                <small><?php echo "'" . $row_employeur['email'] . "'"; ?></small>
                                                                <small class="text-right"><?php echo $row_employeur['created']; ?></small>


                                                                <div class="form-group">
                                                                    <label for="message-text" class="col-form-label">Objet:</label>
                                                                    <h6><?php echo $row_employeur['objet'] ?></h6>
                                                                </div>

                                                                <div class="form-group">
                                                                    <label for="message-text" class="col-form-label">Message:</label>
                                                                    <h6><?php echo $row_employeur['message'] ?></h6>
                                                                </div>
                                                ...
                                                <tr onclick="link" style="cursor:pointer;" data-toggle="modal" data-whatever="@fat" data-target="<?php echo "#envoyerModal" . $row_employeur['id'] ?>">
                                                    <!-- label -->

                                                    <!-- star -->
                                                    <td><i class="fa fa-star text-warning"></i></td>
                                                    <td>
                                                        <span class="mb-0 text-muted"><?php echo $row_employeur['nom'] . " " . $row_employeur['prenom'] ?></span>
                                                    </td>
                                                    <!-- Message -->
                                                    <td>
                                                        <span class="text-dark">
                                                            <?php if (strlen($row_employeur['message']) > 10) {
                                                                $message = substr($row_employeur['message'], 0, 10);
                                                                echo $message . "...";
                                                            } else {
                                                                echo $row_employeur['message'];
                                                            } ?></span>
                                                    </td>
                                                    <!-- Attachment -->

                                                    <!-- Time -->
                                                    <td class="text-muted"><?php echo $row_employeur['created']; ?></td>
                                                    <td class="clickable-td">
                                                        <button type="button" class="btn btn-light" data-id="<?php echo $row_employeur['id']; ?>" onclick="confirmDelete(this)">
                                                            <span class="fa fa-trash-o"></span>
                                                        </button>
                                                    </td>
                                                </tr>
                            ...
                            <div class="table-responsive">
                                <table id="" class="table email-table no-wrap table-hover v-middle mb-0 font-14">
                                    <tbody>
                                        ...
                                        <?php
                                        $sql_messagerie_supp = "SELECT DISTINCT t_messagerie.id,t_messagerie.objet , t_messagerie.message ,t_messagerie.deleted_at,t_employe.nom ,t_employe.prenom,t_employe.email,t_employe.photo ,t_messagerie.created FROM t_messagerie INNER JOIN t_employeur ON t_messagerie.id_employeur='$employeur_id_2' INNER JOIN t_employe ON t_messagerie.id_employe=t_employe.id WHERE t_messagerie.user_send_type='employeur' AND t_messagerie.deleted_at IS NOT NULL ORDER BY t_messagerie.created Desc ";
                                                ...
                                                <div class="modal fade" id="<?php echo "exampleMoadal" . $row_messagerie_supp['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <img src="../img/database_image/<?php echo $row_messagerie_supp['photo']; ?> " alt="avatar" class="rounded-circle img-fluid" style="width:40px; height:40px;">
